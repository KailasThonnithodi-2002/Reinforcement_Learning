...
class Qlearner():
    ...
    def initialize_cartpole_q_table(self, env):
        obs_space = BUCCKET_POSITIONING * CARTPOLE_VELOCITY_BUCKETS * CARTPOLE_THETA_BUCKETS * CARTPOLE_THETA_VELOCITY_BUCKETS
    ...
    def _cartpole_obs_index(self, observation):
        ...
        bucketed_position = self._bucket(position, BUCCKET_POSITIONING, CARTPOLE_POSITION_RANGE)
